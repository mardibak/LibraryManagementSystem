...
namespace Library.Application
{
    public class BookApplication : IBookApplication
    {
        ...
        public OperationResult Create(CreateBook command)
        {
            ...
            var book = new Book(command.Code, command.Name, command.Author, command.Publisher, command.Translator, command.Description, command.CategoryId);
        ...
        public OperationResult Edit(EditBook command)
        {
            ...
            book.Edit(command.Code, command.Name, command.Author, command.Publisher, command.Translator, command.Description, command.CategoryId);
            _bookRepository.SaveChanges();
            return operation.Succeeded();
        }
